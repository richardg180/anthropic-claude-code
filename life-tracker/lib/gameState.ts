...
export const defaultHabits: Habit[] = [
  // ═══════════════════════════════════════════
  // HEALTH - Physical Foundation
  // ═══════════════════════════════════════════
  {
    id: 'h1',
    name: 'Training / Mobility',
    description: 'Workout or mobility routine',
    category: 'health',
    xpReward: 50,
    icon: '💪',
    completed: false,
  ...
  },
  {
    id: 'h3',
    name: '10,000 Steps',
    description: 'Get moving, stay active',
    category: 'health',
    xpReward: 40,
    icon: '🚶',
    completed: false,
  ...
  },
  {
    ...
    description: '5+ mins mindfulness or journaling',
    category: 'health',
    xpReward: 35,
    icon: '🧘',
    completed: false,
  ...
  // ═══════════════════════════════════════════
  // WEALTH - Agency Growth to $100k/mo
  // Inspired by Hormozi, Tony Robbins, Alex Charfen
  // ═══════════════════════════════════════════
  {
    id: 'w1',
    name: 'Outreach / Sales',
    description: 'Volume negates luck - reach out daily',
    category: 'wealth',
    xpReward: 60,
    icon: '📞',
    completed: false,
  ...
  },
  {
    ...
    description: 'Deep work on client results',
    category: 'wealth',
    xpReward: 55,
    icon: '🎯',
    completed: false,
  ...
  },
  {
    ...
    description: 'Post content, build authority',
    category: 'wealth',
    xpReward: 50,
    icon: '📱',
    completed: false,
  ...
  },
  {
    id: 'w4',
    name: 'Learn / Level Up',
    description: 'Read, course, or skill improvement',
    category: 'wealth',
    xpReward: 40,
    icon: '📚',
    completed: false,
  ...
  },
  {
    id: 'w5',
    name: 'Review KPIs',
    description: 'Track metrics, what gets measured grows',
    category: 'wealth',
    xpReward: 35,
    icon: '📊',
    completed: false,
  ...
  // ═══════════════════════════════════════════
  // RELATIONSHIPS - Faith, Family & Marriage
  // God-centered, thriving marriage & family
  // ═══════════════════════════════════════════
  {
    id: 'r1',
    name: 'Prayer & Bible Study',
    description: 'Time with God, family devotion',
  ...
  {
    id: 'r2',
    name: 'Spouse Quality Time',
    description: 'Intentional time with your wife',
    category: 'relationships',
    xpReward: 50,
    icon: '💑',
    completed: false,
  ...
  },
  {
    ...
    description: 'Acts of love and service',
    category: 'relationships',
    xpReward: 45,
    icon: '💝',
    completed: false,
  ...
  },
  {
    ...
    description: 'Express love and appreciation',
    category: 'relationships',
    xpReward: 40,
    icon: '❤️',
    completed: false,
  ...
  },
  {
    id: 'r6',
    name: 'No Phone Zone',
    description: 'Device-free time with family',
    category: 'relationships',
    xpReward: 35,
    icon: '📵',
    completed: false,
...
export const defaultAchievements: Achievement[] = [
  ...
  { id: 'a14', name: 'Temple Builder', description: 'Health level 10', icon: '💚', category: 'health', requirement: 10, type: 'category', unlocked: false, unlockedAt: null },
  { id: 'a15', name: 'Empire Builder', description: 'Wealth level 10', icon: '💛', category: 'wealth', requirement: 10, type: 'category', unlocked: false, unlockedAt: null },
  { id: 'a16', name: 'Family First', description: 'Relationships level 10', icon: '💗', category: 'relationships', requirement: 10, type: 'category', unlocked: false, unlockedAt: null },
];
